...
namespace MeshGrowth
{
    ...
    {
        private MeshGrowthSystem myMeshGrowthSystem;//类似MovingParticle中的全局变量
        //start a current position of all of the vertices,every iteration we are going to push them out
        //and in the next iteration we want to look at the current postion and push them out 
